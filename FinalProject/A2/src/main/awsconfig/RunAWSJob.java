...
public class RunAWSJob {
    ...
    public static void main(String[] args) {
        ...
        // create input analysis and upload data files
...
//                .withJobFlowRole("EMR_EC2_DefaultRole")
    ...
    public static void createFolder(String bucketName, String folder, AmazonS3Client s3) {
        // create meta-data for your analysis and set content-length to 0
		ObjectMetadata metadata = new ObjectMetadata();
		metadata.setContentLength(0);
		// create empty content
		InputStream emptyContent = new ByteArrayInputStream(new byte[0]);
		// create a PutObjectRequest passing the analysis name suffixed by /
		PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName,
				folder + SUFFIX, emptyContent, metadata);
		// send request to S3 to create analysis
