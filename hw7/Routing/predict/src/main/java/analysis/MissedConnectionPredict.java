...
public class MissedConnectionPredict extends Configured implements Tool {

    public int run (String[] args) throws Exception {

        Job job = Job.getInstance();
        job.setJarByClass(MissedConnectionPredict.class);
        job.setJobName("MissedConnectionPredict");
...
//        job.setNumReduceTasks(2); // for test
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new MissedConnectionPredict(), args));
	}
}
