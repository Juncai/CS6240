...
public class MissedConnectionTesting extends Configured implements Tool {

    public int run (String[] args) throws Exception {

        Job job = Job.getInstance();
        job.setJarByClass(MissedConnectionTesting.class);
        job.setJobName("MissedConnectionTesting");
...
//        job.setNumReduceTasks(2); // for test
	...
	public static void main(String[] args) throws Exception {
		System.exit(ToolRunner.run(new MissedConnectionTesting(), args));
	}
}
