...
# credit: joran's post: http://stackoverflow.com/questions/19170130/combining-random-forests-built-with-different-training-sets-in-r
my_combine <- function (...) 
{
...
#			forest <- combine(forest, nextForest)
			forest <- my_combine(forest, nextForest)
		}
	}
